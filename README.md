...
Upload every file and folder from inside this package to the root of `anauz/itpiazza`, replace existing files and commit to `main`. Cloudflare Pages will deploy automatically.
